...
class DetallePokemon : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        desiscion= intent.getStringExtra("version")
        var btnAnterior: ImageView? =findViewById(R.id.btnBack)
        var btnSiguiente: ImageView? =findViewById(R.id.btnNext)
        if (btnAnterior != null) {
            btnAnterior.setOnClickListener(object : View.OnClickListener{
                ...
                try {
                    ...
                    runOnUiThread {
                        if (pokemon==null){
                            ...
                            if(desiscion.equals("normal")){
                                var link1 = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/${pokemon!!.id}.png"
                                Glide.with(this@DetallePokemon).load(link1).into(img_oficial3)
                            }else{
                                var link2 = "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/shiny/${pokemon!!.id}.png"
                                Glide.with(this@DetallePokemon).load(link2).into(img_oficial3)
                            }
    ...
    fun llamaranterior(){
        ...
        id=id-1
        if(id.equals(0)){
            Toast.makeText(this@DetallePokemon,"Usted esta en el primer pokemon",Toast.LENGTH_LONG).show()
        }else{
            var l1 : LinearLayout = this.findViewById(R.id.LL_1)
            var l2 : LinearLayout = this.findViewById(R.id.LL_2)
            var l3 : LinearLayout = this.findViewById(R.id.LL_3)
